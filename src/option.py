...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--all_file', type=str, default='data/KPMP_all.txt', help='path to all data')
        ...
        parser.add_argument('--visualization', action='store_true', default=False, help='generate CAMs, only available on evaluation mode')
