...
def preprocess_global(path_ori, width_resize=2560, height_resize=1920):
    ...
    for file_ in all_files:
        ...
        if os.path.exists('data/masks/{}_annt.jpg'.format(name)):
            ...
            #crop = ori.read_region((0,0), 0, (width,height))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path_ori', type=str, default='/home/eikthedragonslayer/DATA/AJPA2021/data/toolarge/', help='path to dataset where images store')
    parser.add_argument('--path_mask', type=str, default='/home/eikthedragonslayer/DATA/AJPA2021/data/A1/', help='path to dataset where masks (if possible) store')
